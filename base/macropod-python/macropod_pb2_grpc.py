...
class MacroPodDeployerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TTLDelete = channel.unary_unary(
                ...
                response_deserializer=macropod__pb2.MacroPodReply.FromString,
                _registered_method=True)
        self.UpdateDeployerManifest = channel.unary_unary(
                '/macropod.MacroPodDeployer/UpdateDeployerManifest',
...
class MacroPodDeployerServicer(object):
    ...
    def UpdateDeployerManifest(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MacroPodDeployerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateDeployerManifest': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateDeployerManifest,
...
class MacroPodDeployer(object):
    ...
    @staticmethod
    def UpdateDeployerManifest(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
...
class MacroPodIngressStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EvalSummary = channel.unary_unary(
                ...
                response_deserializer=macropod__pb2.MacroPodReply.FromString,
                _registered_method=True)
        self.UpdateIngressManifest = channel.unary_unary(
                '/macropod.MacroPodIngress/UpdateIngressManifest',
                request_serializer=macropod__pb2.MacroPodManifest.SerializeToString,
                response_deserializer=macropod__pb2.MacroPodReply.FromString,
                _registered_method=True)
...
class MacroPodIngressServicer(object):
    ...
    def UpdateIngressManifest(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MacroPodIngressServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateIngressManifest': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateIngressManifest,
                    request_deserializer=macropod__pb2.MacroPodManifest.FromString,
                    response_serializer=macropod__pb2.MacroPodReply.SerializeToString,
            ),
    }
...
class MacroPodIngress(object):
    ...
    @staticmethod
    def UpdateIngressManifest(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,

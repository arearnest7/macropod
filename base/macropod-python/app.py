...
class MacroPodFunctionServicer(pb_grpc.MacroPodFunctionServicer):
    def Invoke(self, request, context):
        ctx_in = {"Workflow": request.Workflow, "Function": request.Function, "Target": request.Target, "Text": request.Text, "JSON": request.JSON, "Data": request.Data, "WorkflowID": request.WorkflowID, "Depth": request.Depth, "Width": request.Width}

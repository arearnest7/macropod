...
class MacroPodFunctionServicer(pb_grpc.MacroPodFunctionServicer):
    def Invoke(self, request, context):
        ...
        reply, code = FunctionHandler({"Function": request.Function, "Data": request.Data, "Text": request.Text, "WorkflowID": request.WorkflowID, "Depth": request.Depth, "Width": request.Width})

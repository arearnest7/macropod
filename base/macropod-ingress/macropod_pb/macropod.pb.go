...
type EvalStruct struct {
	...
	InvocationConcurrencies []int32                `protobuf:"varint,2,rep,packed,name=InvocationConcurrencies,proto3" json:"InvocationConcurrencies,omitempty"`
...
func (x *EvalStruct) GetInvocationConcurrencies() []int32 {
	if x != nil {
		return x.InvocationConcurrencies
	}
	return nil
}
...
type WorkflowStruct struct {
	...
	Config        *ConfigStruct              `protobuf:"bytes,4,opt,name=Config,proto3,oneof" json:"Config,omitempty"`
	Eval          *EvalStruct                `protobuf:"bytes,5,opt,name=Eval,proto3,oneof" json:"Eval,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WorkflowStruct) GetPayloads() [][]byte {
	if x != nil {
		return x.Payloads
	}
	return nil
...
type PodMetadata struct {
	...
	Ingresses     map[string]string      `protobuf:"bytes,5,rep,name=Ingresses,proto3" json:"Ingresses,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PodMetadata) GetIngresses() map[string]string {
	if x != nil {
		return x.Ingresses
	}
	return nil
...
type DeploymentMetadata struct {
	...
	Pods               map[string]*PodMetadata `protobuf:"bytes,3,rep,name=Pods,proto3" json:"Pods,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *DeploymentMetadata) GetPods() map[string]*PodMetadata {
	if x != nil {
		return x.Pods
	}
	return nil
...
type WorkflowMetadata struct {
	...
	Deployments        []*DeploymentMetadata  `protobuf:"bytes,3,rep,name=Deployments,proto3" json:"Deployments,omitempty"`
...
func (x *WorkflowMetadata) GetDeployments() []*DeploymentMetadata {
	if x != nil {
...
type FunctionRequest struct {
	...
	InvocationID  *string                `protobuf:"bytes,4,opt,name=InvocationID,proto3,oneof" json:"InvocationID,omitempty"`
...
func (x *FunctionRequest) GetInvocationID() string {
...
func (x *IngressRequest) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
const file_macropod_proto_rawDesc = "" +
	"\n" +
	"\x0emacropod.proto\x12\bmacropod\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9f\x03\n" +
	...
	"\x17InvocationConcurrencies\x18\x02 \x03(\x05R\x17InvocationConcurrencies\x12%\n" +
	"\vInvocations\x18\x03 \x01(\x05H\x00R\vInvocations\x88\x01\x01B\x0e\n" +
	"\f_Invocations\"\xd7\x02\n" +
	"\x0eWorkflowStruct\x12\x12\n" +
	"\x04Name\x18\x01 \x01(\tR\x04Name\x12E\n" +
	"\tFunctions\x18\x02 \x03(\v2'.macropod.WorkflowStruct.FunctionsEntryR\tFunctions\x12\x1a\n" +
	"\bPayloads\x18\x03 \x03(\fR\bPayloads\x123\n" +
	"\x06Config\x18\x04 \x01(\v2\x16.macropod.ConfigStructH\x00R\x06Config\x88\x01\x01\x12-\n" +
	"\x04Eval\x18\x05 \x01(\v2\x14.macropod.EvalStructH\x01R\x04Eval\x88\x01\x01\x1aV\n" +
	...
	"\bNodeName\x18\x04 \x01(\tH\x02R\bNodeName\x88\x01\x01\x12B\n" +
	"\tIngresses\x18\x05 \x03(\v2$.macropod.PodMetadata.IngressesEntryR\tIngresses\x1a<\n" +
	...
	"\x04Pods\x18\x03 \x03(\v2&.macropod.DeploymentMetadata.PodsEntryR\x04Pods\x123\n" +
	"\x12InvocationsCurrent\x18\x04 \x01(\x05H\x01R\x12InvocationsCurrent\x88\x01\x01\x12;\n" +
	"\bLastUsed\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampH\x02R\bLastUsed\x88\x01\x01\x1aN\n" +
	"\tPodsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.macropod.PodMetadataR\x05value:\x028\x01B\r\n" +
	"\v_EntrypointB\x15\n" +
	"\x13_InvocationsCurrentB\v\n" +
	"\t_LastUsed\"\xba\x04\n" +
	"\x10WorkflowMetadata\x124\n" +
	"\bWorkflow\x18\x01 \x01(\v2\x18.macropod.WorkflowStructR\bWorkflow\x12H\n" +
	"\x10DeploymentConfig\x18\x02 \x01(\v2\x1c.macropod.DeploymentMetadataR\x10DeploymentConfig\x12>\n" +
	"\vDeployments\x18\x03 \x03(\v2\x1c.macropod.DeploymentMetadataR\vDeployments\x12/\n" +
	...
	"\x10InvocationsTotal\x18\b \x01(\x05H\x04R\x10InvocationsTotal\x88\x01\x01B\x13\n" +
	...
	"\x06Memory\x18\x02 \x01(\x01R\x06Memory\"\xb5\x06\n" +
	...
	"\x06_ReplyB\a\n" +
	"\x05_Code\"\xf5\x01\n" +
	"\x0fFunctionRequest\x12\x1a\n" +
	"\bFunction\x18\x01 \x01(\tR\bFunction\x12\x17\n" +
	"\x04Data\x18\x02 \x01(\fH\x00R\x04Data\x88\x01\x01\x12\x17\n" +
	"\x04Text\x18\x03 \x01(\tH\x01R\x04Text\x88\x01\x01\x12'\n" +
	"\fInvocationID\x18\x04 \x01(\tH\x02R\fInvocationID\x88\x01\x01\x12\x19\n" +
	"\x05Depth\x18\x05 \x01(\x05H\x03R\x05Depth\x88\x01\x01\x12\x19\n" +
	"\x05Width\x18\x06 \x01(\x05H\x04R\x05Width\x88\x01\x01B\a\n" +
	"\x05_DataB\a\n" +
	"\x05_TextB\x0f\n" +
	"\r_InvocationIDB\b\n" +
	"\x06_DepthB\b\n" +
	...
	"\fWorkflowName\x18\x01 \x01(\tR\fWorkflowName\x12\x1d\n" +
	...
	"\vEvalSummary\x12\x1c.macropod.IngressEvalRequest\x1a\x17.macropod.MacroPodReply\x12L\n" +
...
var file_macropod_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_macropod_proto_goTypes = []any{
	...
	nil,                             // 16: macropod.FunctionStruct.EndpointsEntry
	nil,                             // 17: macropod.FunctionStruct.EnvsEntry
	nil,                             // 18: macropod.FunctionStruct.SecretsEntry
	nil,                             // 19: macropod.WorkflowStruct.FunctionsEntry
	nil,                             // 20: macropod.PodMetadata.IngressesEntry
	nil,                             // 21: macropod.DeploymentMetadata.PodsEntry
	nil,                             // 22: macropod.WorkflowIngressMetadata.IngressesEntry
	nil,                             // 23: macropod.WorkflowIngressMetadata.LabelsEntry
	nil,                             // 24: macropod.FunctionIngressMetadata.IngressesEntry
	nil,                             // 25: macropod.FunctionIngressMetadata.LabelsEntry
	nil,                             // 26: macropod.MacroPodManifest.WorkflowsEntry
	nil,                             // 27: macropod.MacroPodManifest.WorkflowIngressesEntry
	nil,                             // 28: macropod.MacroPodManifest.FunctionIngressesEntry
	nil,                             // 29: macropod.MacroPodManifest.NodeMetricsEntry
	(*timestamppb.Timestamp)(nil),   // 30: google.protobuf.Timestamp
}
var file_macropod_proto_depIdxs = []int32{
	16, // 0: macropod.FunctionStruct.Endpoints:type_name -> macropod.FunctionStruct.EndpointsEntry
	17, // 1: macropod.FunctionStruct.Envs:type_name -> macropod.FunctionStruct.EnvsEntry
	18, // 2: macropod.FunctionStruct.Secrets:type_name -> macropod.FunctionStruct.SecretsEntry
	19, // 3: macropod.WorkflowStruct.Functions:type_name -> macropod.WorkflowStruct.FunctionsEntry
	1,  // 4: macropod.WorkflowStruct.Config:type_name -> macropod.ConfigStruct
	2,  // 5: macropod.WorkflowStruct.Eval:type_name -> macropod.EvalStruct
	20, // 6: macropod.PodMetadata.Ingresses:type_name -> macropod.PodMetadata.IngressesEntry
	21, // 7: macropod.DeploymentMetadata.Pods:type_name -> macropod.DeploymentMetadata.PodsEntry
	30, // 8: macropod.DeploymentMetadata.LastUsed:type_name -> google.protobuf.Timestamp
	...
	5,  // 11: macropod.WorkflowMetadata.Deployments:type_name -> macropod.DeploymentMetadata
	30, // 12: macropod.WorkflowMetadata.LastUpdated:type_name -> google.protobuf.Timestamp
	22, // 13: macropod.WorkflowIngressMetadata.Ingresses:type_name -> macropod.WorkflowIngressMetadata.IngressesEntry
	23, // 14: macropod.WorkflowIngressMetadata.Labels:type_name -> macropod.WorkflowIngressMetadata.LabelsEntry
	24, // 15: macropod.FunctionIngressMetadata.Ingresses:type_name -> macropod.FunctionIngressMetadata.IngressesEntry
	25, // 16: macropod.FunctionIngressMetadata.Labels:type_name -> macropod.FunctionIngressMetadata.LabelsEntry
	26, // 17: macropod.MacroPodManifest.Workflows:type_name -> macropod.MacroPodManifest.WorkflowsEntry
	27, // 18: macropod.MacroPodManifest.WorkflowIngresses:type_name -> macropod.MacroPodManifest.WorkflowIngressesEntry
	28, // 19: macropod.MacroPodManifest.FunctionIngresses:type_name -> macropod.MacroPodManifest.FunctionIngressesEntry
	29, // 20: macropod.MacroPodManifest.NodeMetrics:type_name -> macropod.MacroPodManifest.NodeMetricsEntry
	1,  // 21: macropod.MacroPodManifest.DefaultConfig:type_name -> macropod.ConfigStruct
	0,  // 22: macropod.WorkflowStruct.FunctionsEntry.value:type_name -> macropod.FunctionStruct
	4,  // 23: macropod.DeploymentMetadata.PodsEntry.value:type_name -> macropod.PodMetadata
	6,  // 24: macropod.MacroPodManifest.WorkflowsEntry.value:type_name -> macropod.WorkflowMetadata
	7,  // 25: macropod.MacroPodManifest.WorkflowIngressesEntry.value:type_name -> macropod.WorkflowIngressMetadata
	8,  // 26: macropod.MacroPodManifest.FunctionIngressesEntry.value:type_name -> macropod.FunctionIngressMetadata
	9,  // 27: macropod.MacroPodManifest.NodeMetricsEntry.value:type_name -> macropod.NodeMetricsMetadata
	12, // 28: macropod.MacroPodFunction.Invoke:input_type -> macropod.FunctionRequest
	1,  // 29: macropod.MacroPodDeployer.Config:input_type -> macropod.ConfigStruct
	3,  // 30: macropod.MacroPodDeployer.CreateWorkflow:input_type -> macropod.WorkflowStruct
	3,  // 31: macropod.MacroPodDeployer.UpdateWorkflow:input_type -> macropod.WorkflowStruct
	13, // 32: macropod.MacroPodDeployer.DeleteWorkflow:input_type -> macropod.DeployerRequest
	13, // 33: macropod.MacroPodDeployer.UpdateDeployments:input_type -> macropod.DeployerRequest
	13, // 34: macropod.MacroPodDeployer.CreateDeployment:input_type -> macropod.DeployerRequest
	13, // 35: macropod.MacroPodDeployer.TTLDelete:input_type -> macropod.DeployerRequest
	10, // 36: macropod.MacroPodDeployer.UpdateDeployerManifest:input_type -> macropod.MacroPodManifest
	1,  // 37: macropod.MacroPodIngress.Config:input_type -> macropod.ConfigStruct
	14, // 38: macropod.MacroPodIngress.WorkflowInvoke:input_type -> macropod.IngressRequest
	12, // 39: macropod.MacroPodIngress.FunctionInvoke:input_type -> macropod.FunctionRequest
	3,  // 40: macropod.MacroPodIngress.CreateWorkflow:input_type -> macropod.WorkflowStruct
	3,  // 41: macropod.MacroPodIngress.UpdateWorkflow:input_type -> macropod.WorkflowStruct
	14, // 42: macropod.MacroPodIngress.DeleteWorkflow:input_type -> macropod.IngressRequest
	3,  // 43: macropod.MacroPodIngress.Eval:input_type -> macropod.WorkflowStruct
	15, // 44: macropod.MacroPodIngress.EvalMetrics:input_type -> macropod.IngressEvalRequest
	15, // 45: macropod.MacroPodIngress.EvalLatency:input_type -> macropod.IngressEvalRequest
	15, // 46: macropod.MacroPodIngress.EvalSummary:input_type -> macropod.IngressEvalRequest
	10, // 47: macropod.MacroPodIngress.UpdateIngressManifest:input_type -> macropod.MacroPodManifest
	11, // 48: macropod.MacroPodFunction.Invoke:output_type -> macropod.MacroPodReply
	11, // 49: macropod.MacroPodDeployer.Config:output_type -> macropod.MacroPodReply
	11, // 50: macropod.MacroPodDeployer.CreateWorkflow:output_type -> macropod.MacroPodReply
	11, // 51: macropod.MacroPodDeployer.UpdateWorkflow:output_type -> macropod.MacroPodReply
	11, // 52: macropod.MacroPodDeployer.DeleteWorkflow:output_type -> macropod.MacroPodReply
	11, // 53: macropod.MacroPodDeployer.UpdateDeployments:output_type -> macropod.MacroPodReply
	11, // 54: macropod.MacroPodDeployer.CreateDeployment:output_type -> macropod.MacroPodReply
	11, // 55: macropod.MacroPodDeployer.TTLDelete:output_type -> macropod.MacroPodReply
	11, // 56: macropod.MacroPodDeployer.UpdateDeployerManifest:output_type -> macropod.MacroPodReply
	11, // 57: macropod.MacroPodIngress.Config:output_type -> macropod.MacroPodReply
	11, // 58: macropod.MacroPodIngress.WorkflowInvoke:output_type -> macropod.MacroPodReply
	11, // 59: macropod.MacroPodIngress.FunctionInvoke:output_type -> macropod.MacroPodReply
	11, // 60: macropod.MacroPodIngress.CreateWorkflow:output_type -> macropod.MacroPodReply
	11, // 61: macropod.MacroPodIngress.UpdateWorkflow:output_type -> macropod.MacroPodReply
	11, // 62: macropod.MacroPodIngress.DeleteWorkflow:output_type -> macropod.MacroPodReply
	11, // 63: macropod.MacroPodIngress.Eval:output_type -> macropod.MacroPodReply
	11, // 64: macropod.MacroPodIngress.EvalMetrics:output_type -> macropod.MacroPodReply
	11, // 65: macropod.MacroPodIngress.EvalLatency:output_type -> macropod.MacroPodReply
	11, // 66: macropod.MacroPodIngress.EvalSummary:output_type -> macropod.MacroPodReply
	11, // 67: macropod.MacroPodIngress.UpdateIngressManifest:output_type -> macropod.MacroPodReply

...
const (
	...
	MacroPodDeployer_UpdateDeployerManifest_FullMethodName = "/macropod.MacroPodDeployer/UpdateDeployerManifest"
)
...
type MacroPodDeployerClient interface {
	...
	UpdateDeployerManifest(ctx context.Context, in *MacroPodManifest, opts ...grpc.CallOption) (*MacroPodReply, error)
}
...
func (c *macroPodDeployerClient) UpdateDeployerManifest(ctx context.Context, in *MacroPodManifest, opts ...grpc.CallOption) (*MacroPodReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MacroPodReply)
	err := c.cc.Invoke(ctx, MacroPodDeployer_UpdateDeployerManifest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MacroPodDeployerServer interface {
	...
	UpdateDeployerManifest(context.Context, *MacroPodManifest) (*MacroPodReply, error)
...
func (UnimplementedMacroPodDeployerServer) UpdateDeployerManifest(context.Context, *MacroPodManifest) (*MacroPodReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateDeployerManifest not implemented")
}
...
func _MacroPodDeployer_UpdateDeployerManifest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MacroPodManifest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MacroPodDeployerServer).UpdateDeployerManifest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MacroPodDeployer_UpdateDeployerManifest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MacroPodDeployerServer).UpdateDeployerManifest(ctx, req.(*MacroPodManifest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MacroPodDeployer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateDeployerManifest",
			Handler:    _MacroPodDeployer_UpdateDeployerManifest_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "macropod.proto",
...
const (
	...
	MacroPodIngress_UpdateIngressManifest_FullMethodName = "/macropod.MacroPodIngress/UpdateIngressManifest"
)
...
type MacroPodIngressClient interface {
	...
	UpdateIngressManifest(ctx context.Context, in *MacroPodManifest, opts ...grpc.CallOption) (*MacroPodReply, error)
}
...
func (c *macroPodIngressClient) UpdateIngressManifest(ctx context.Context, in *MacroPodManifest, opts ...grpc.CallOption) (*MacroPodReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MacroPodReply)
	err := c.cc.Invoke(ctx, MacroPodIngress_UpdateIngressManifest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MacroPodIngressServer interface {
	...
	UpdateIngressManifest(context.Context, *MacroPodManifest) (*MacroPodReply, error)
...
func (UnimplementedMacroPodIngressServer) UpdateIngressManifest(context.Context, *MacroPodManifest) (*MacroPodReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateIngressManifest not implemented")
}
...
func _MacroPodIngress_UpdateIngressManifest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MacroPodManifest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MacroPodIngressServer).UpdateIngressManifest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MacroPodIngress_UpdateIngressManifest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MacroPodIngressServer).UpdateIngressManifest(ctx, req.(*MacroPodManifest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MacroPodIngress_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateIngressManifest",
			Handler:    _MacroPodIngress_UpdateIngressManifest_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "macropod.proto",

...
TAG=${2:-latest}
DOCKER_BUILDKIT=1
docker build base/macropod-ingress -t $ID/macropod-ingress:$TAG && docker push $ID/macropod-ingress:$TAG
docker build base/macropod-deployer -t $ID/macropod-deployer:$TAG && docker push $ID/macropod-deployer:$TAG

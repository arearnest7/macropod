...
func FunctionHandler(res http.ResponseWriter, req *http.Request) {
    ...
    reply, _ := function.FunctionHandler(function.Context{Request: in.Data, WorkflowId: in.WorkflowId, Depth: int(in.Depth), Width: int(in.Width), RequestType: in.RequestType, InvokeType: "GRPC", IsJson: false})

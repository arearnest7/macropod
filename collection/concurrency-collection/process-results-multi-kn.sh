...
LATENCY_FILES_1=${5:-"kn-full-election-1.csv kn-original-election-1.csv kn-partial-election-1.csv kn-full-feature-1.csv kn-original-feature-1.csv kn-partial-feature-1.csv kn-full-hotel-1.csv kn-original-hotel-1.csv kn-partial-hotel-1.csv kn-full-pipelined-1.csv kn-original-pipelined-1.csv kn-partial-pipelined-1.csv kn-full-sentiment-1.csv kn-original-sentiment-1.csv kn-partial-sentiment-1.csv kn-full-video-1.csv kn-original-video-1.csv kn-partial-video-1.csv"}
...
LATENCY_FILES_2=${8:-"kn-full-election-2.csv kn-original-election-2.csv kn-partial-election-2.csv kn-full-feature-2.csv kn-original-feature-2.csv kn-partial-feature-2.csv kn-full-hotel-2.csv kn-original-hotel-2.csv kn-partial-hotel-2.csv kn-full-pipelined-2.csv kn-original-pipelined-2.csv kn-partial-pipelined-2.csv kn-full-sentiment-2.csv kn-original-sentiment-2.csv kn-partial-sentiment-2.csv kn-full-video-2.csv kn-original-video-2.csv kn-partial-video-2.csv"}
...
LATENCY_FILES_4=${11:-"kn-full-election-4.csv kn-original-election-4.csv kn-partial-election-4.csv kn-full-feature-4.csv kn-original-feature-4.csv kn-partial-feature-4.csv kn-full-hotel-4.csv kn-original-hotel-4.csv kn-partial-hotel-4.csv kn-full-pipelined-4.csv kn-original-pipelined-4.csv kn-partial-pipelined-4.csv kn-full-sentiment-4.csv kn-original-sentiment-4.csv kn-partial-sentiment-4.csv kn-full-video-4.csv kn-original-video-4.csv kn-partial-video-4.csv"}
...
go run ../../tools/collection/processing-scripts/process-latency.go 5 $LATENCY_RESULTS_1 $DIR $LATENCY_FILES_1
go run ../../tools/collection/processing-scripts/process-latency.go 10 $LATENCY_RESULTS_2 $DIR $LATENCY_FILES_2
go run ../../tools/collection/processing-scripts/process-latency.go 20 $LATENCY_RESULTS_4 $DIR $LATENCY_FILES_4
go run ../../tools/collection/processing-scripts/process-latency.go 40 $LATENCY_RESULTS_8 $DIR $LATENCY_FILES_8
go run ../../tools/collection/processing-scripts/process-latency.go 80 $LATENCY_RESULTS_16 $DIR $LATENCY_FILES_16
go run ../../tools/collection/processing-scripts/process-latency.go 160 $LATENCY_RESULTS_32 $DIR $LATENCY_FILES_32
go run ../../tools/collection/processing-scripts/process-latency.go 320 $LATENCY_RESULTS_64 $DIR $LATENCY_FILES_64
go run ../../tools/collection/processing-scripts/process-latency.go 640 $LATENCY_RESULTS_128 $DIR $LATENCY_FILES_128

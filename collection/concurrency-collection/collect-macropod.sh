...
sleep 180s
hey -n $C -c $C -t 1000 -o csv -D $PAYLOAD -m POST -T application/json http://10.43.190.1/$BENCHMARK
hey -n $N -c $C -t 1000 -o csv -D $PAYLOAD -m POST -T application/json http://10.43.190.1/$BENCHMARK >> macropod-$BENCHMARK.csv
